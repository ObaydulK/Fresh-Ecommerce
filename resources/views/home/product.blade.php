<div class="heading_container heading_center">
    <h2 class="py-10 font-bold text-black sm:text-3xl m-auto">
        Our <span>products</span>
    </h2>
</div>
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 justify-between gap-2">
    @foreach ($products as $product)
        <section class="product_section layout_padding">
            <div class="container">
                <div class="img-box flex justify-center relative">
                    <img class="w-[200px] h-[200px]" src="{{url('/product', $product->image)}}" alt="">
                </div>
                <div class="px-5 pb-5">
                ...
                <div class="btn-box">
                    <a href="{{url('/ProductDitiles', $product->id)}}"
