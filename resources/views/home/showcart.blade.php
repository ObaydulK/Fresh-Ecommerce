                        ...
                        @foreach ($cart as $carts)
                            <tbody>
                                <tr>
                                    ...
                                    <td scope="col"
                                        class="border px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase dark:text-neutral-500">
                                        <img class="w-14" src="/product/{{$carts->image}}" alt=""></td>
                                    <td scope="col"
                                        class="border px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase dark:text-neutral-500">
                                        <a class="btn btn-danger" onclick="return confirm('Delete Now this Cart')" href="{{url('/remove_cart', $carts->id)}}", >Remove Product</a>  
                                    </td>
